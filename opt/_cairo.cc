...
void crack_ext__cairo_init(crack::ext::Module *mod) {
    ...
    crack::ext::Type *type_cairo_font_extents_t = mod->addType("cairo_font_extents_t");
    ...
    crack::ext::Type *type_cairo_path_t = mod->addType("cairo_path_t");
    type_cairo_path_t->finish();

    crack::ext::Type *type_cairo_pattern_t = mod->addType("cairo_pattern_t");
    type_cairo_pattern_t->finish();

    crack::ext::Type *type_cairo_rectangle_int_t = mod->addType("cairo_rectangle_int_t");
    ...
    crack::ext::Type *type_cairo_scaled_font_t = mod->addType("cairo_scaled_font_t");
    ...
    f = mod->addFunc(array_pbyte_q, "cairo_toy_font_face_get_family",
    ...
    f = mod->addFunc(array_pbyte_q, "cairo_status_to_string",
    ...
    f->addArg(type_cairo_surface_t, "surface");
    f->addArg(array_pbyte_q, "filename");
